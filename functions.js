...
document.addEventListener("DOMContentLoaded", () => {
    toggleCalculator("tC"),
        toggleCalculator("cm3"),
        toggleCalculator("cc3"),
        toggleCalculator("ct"),
        toggleCalculator("cr"),
        toggleCalculator("customCalculator");
});
...
function addDataSet() {
    ...
    newDataSet.innerHTML = '<input type="number" class="data" placeholder="Ingrese calorías del artefacto"><button onclick="removeDataSet(this)" class="eliminar">X</button>';
